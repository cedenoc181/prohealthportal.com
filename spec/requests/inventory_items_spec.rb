...
RSpec.describe "InventoryItems", type: :request do
  ...
  describe "GET /index of inventory" do
    ...
    describe "Post method for inventory items #create" do
      ...
      # test for the non admin inventory item post route
      ...
      it "should only allow user(non admin) to create inventory for thier associated clinic" do
         west_clinic = Clinic.create!(clinic_location_name: "West", clinic_location_address: "180 westend ave ...")
    ...
    describe "inventory item patch method #update" do 
      ...
      it "should update if inventory item has the same clinic_id/ non admin test" do 
        update_clorox_params = { count: 5}
