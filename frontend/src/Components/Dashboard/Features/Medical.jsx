...
<div className="selected-menu">{ defaultLanguage ? "English Forms" : "Spanish Forms"}</div>
  <br />
    ...
    <button className="filter-buttons" onClick={handleFilter} data-toggle="tooltip" data-placement="top" title="Filter through document tags">Filter<span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sliders" viewBox="0 0 16 16">
