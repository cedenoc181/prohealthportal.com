class MedifileSerializer < ActiveModel::Serializer
  ...
  attributes :id, :title, :description, :instructions, :file_cover_alt, :language, :file_owner_id, :file_receiver_id, :file_link_url, :file_cover_url, :users, :created_at, :updated_at
